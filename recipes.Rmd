...
baseline_recipe<-recipe(percent_dem ~ ., train) %>%
  step_mutate(
    ...
    # Race & Ethnicity
    per_white = (x0037e / x0001e) , # white race percentage
    per_black = (x0038e / x0001e) , #black race percentage
    per_native = (x0039e / x0001e) , # native race percentage
    per_asia = (x0044e / x0001e) , # asian race percentage
    per_pacific = (x0052e / x0001e) , # pacific islander race percentage 
    per_other = (x0057e / x0001e) ,  # other race percentage
    per_latina = (x0071e / x0001e) , # latin race percentage
    ...
    Male_Pop_Percentage = (x0002e / x0001e) ,
    Female_Pop_Percentage = (x0003e / x0001e) ,
    Age_18_over_male_pct = (x0026e/x0021e) ,
    Age_18_over_female_pct = (x0027e/x0021e) ,
    Age_65_over_male_pct = (x0030e/x0029e) ,
    Age_65_over_female_pct = (x0031e/x0029e),
    ...
    Age_18_and_under_pct = (Age_18_and_under / x0001e) ,
    Age_18_to_34_pct = (Age_18_to_34 / x0001e) ,
    Age_35_to_44_pct = (Age_35_to_44 / x0001e) ,
    Age_45_to_64_pct = (Age_45_to_64 / x0001e) ,
    Age_65_and_above_pct = (Age_65_and_above / x0001e) ,
...
glm_recipe <- baseline_recipe %>% 
  step_BoxCox(all_numeric(),-all_outcomes())%>%
  step_pca(all_predictors(), num_comp = 115)
```

```{r}
nnet_recipe <- baseline_recipe %>% 
  ...
  step_normalize(all_numeric(), -all_outcomes(),-x2013_code_X1,-x2013_code_X2,-x2013_code_X3,-x2013_code_X4,-x2013_code_X5)%>%  # Normalize numeric variables
   step_pca(all_predictors(), num_comp = 55)
...
gbm_recipe<-baseline_recipe%>%step_select(top_features,percent_dem)
prep_rec <- prep(gbm_recipe)
juice(prep_rec)

##alternative

gbm_recipe <- recipe(
  percent_dem ~., data = train)%>%
  step_mutate(
  ...
  step_rm(id,x0001e,x0002e, x0003e, x0005e, x0006e, x0007e, x0008e, x0009e, x0010e, x0011e, 
          ...
          c01_008e, c01_009e, c01_010e, c01_011e, c01_012e, c01_013e, c01_014e, 
          c01_015e, c01_016e, c01_017e, c01_018e, c01_019e, c01_020e, c01_021e, 
          c01_022e, c01_023e, c01_024e, c01_025e, c01_026e,c01_027e,income_per_cap_2016,income_per_cap_2017,income_per_cap_2018,income_per_cap_2019,income_per_cap_2020,gdp_2017,gdp_2018,gdp_2019,x2013_code)%>%step_impute_knn(all_predictors())%>%
